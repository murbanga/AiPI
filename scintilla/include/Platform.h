...
protected:
	...
	SFont(const SFont &) {}
	SFont &operator=(const SFont &) { id=0; return *this; }
public:
	SFont();
	virtual ~SFont();
...
public:
	...
	virtual void DrawTextNoClip(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextClipped(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back)=0;
	virtual void DrawTextTransparent(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore)=0;
	virtual void MeasureWidths(SFont &font_, const char *s, int len, int *positions)=0;
	virtual int WidthText(SFont &font_, const char *s, int len)=0;
	virtual int WidthChar(SFont &font_, char ch)=0;
	virtual int Ascent(SFont &font_)=0;
	virtual int Descent(SFont &font_)=0;
	virtual int InternalLeading(SFont &font_)=0;
	virtual int ExternalLeading(SFont &font_)=0;
	virtual int Height(SFont &font_)=0;
	virtual int AverageCharWidth(SFont &font_)=0;
