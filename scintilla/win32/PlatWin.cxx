...
void SFont::Create(const char *faceName, int characterSet, int size,
...
public:
	...
	void DrawTextCommon(PRectangle rc, SFont &font_, int ybase, const char *s, int len, UINT fuOptions);
	void DrawTextNoClip(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back);
	void DrawTextClipped(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore, ColourAllocated back);
	void DrawTextTransparent(PRectangle rc, SFont &font_, int ybase, const char *s, int len, ColourAllocated fore);
	void MeasureWidths(SFont &font_, const char *s, int len, int *positions);
	int WidthText(SFont &font_, const char *s, int len);
	int WidthChar(SFont &font_, char ch);
	int Ascent(SFont &font_);
	int Descent(SFont &font_);
	int InternalLeading(SFont &font_);
	int ExternalLeading(SFont &font_);
	int Height(SFont &font_);
	int AverageCharWidth(SFont &font_);
...
void SurfaceImpl::SetFont(SFont &font_) {
	if (font_.GetID() != font) {
		if (fontOld) {
...
void SurfaceImpl::DrawTextCommon(PRectangle rc, SFont &font_, int ybase, const char *s, int len, UINT fuOptions) {
	SetFont(font_);
	RECT rcw = RectFromPRectangle(rc);
	SIZE sz={0,0};
	int pos = 0;
...
void SurfaceImpl::DrawTextNoClip(PRectangle rc, SFont &font_, int ybase, const char *s, int len,
...
void SurfaceImpl::DrawTextClipped(PRectangle rc, SFont &font_, int ybase, const char *s, int len,
	ColourAllocated fore, ColourAllocated back) {
	::SetTextColor(hdc, fore.AsLong());
	::SetBkColor(hdc, back.AsLong());
...
void SurfaceImpl::DrawTextTransparent(PRectangle rc, SFont &font_, int ybase, const char *s, int len,
...
int SurfaceImpl::WidthText(SFont &font_, const char *s, int len) {
	SetFont(font_);
	SIZE sz={0,0};
	if (unicodeMode) {
		wchar_t tbuf[MAX_US_LEN];
...
void SurfaceImpl::MeasureWidths(SFont &font_, const char *s, int len, int *positions) {
	SetFont(font_);
	SIZE sz={0,0};
	int fit = 0;
	if (unicodeMode) {
...
int SurfaceImpl::WidthChar(SFont &font_, char ch) {
	SetFont(font_);
	SIZE sz;
...
int SurfaceImpl::Ascent(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
...
int SurfaceImpl::Descent(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
	return tm.tmDescent;
...
int SurfaceImpl::InternalLeading(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
int SurfaceImpl::ExternalLeading(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
int SurfaceImpl::Height(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
	return tm.tmHeight;
...
int SurfaceImpl::AverageCharWidth(SFont &font_) {
	SetFont(font_);
	TEXTMETRIC tm;
	::GetTextMetrics(hdc, &tm);
...
void Window::SetFont(SFont &font) {
...
void ListBoxX::SetFont(SFont &font) {
	LOGFONT lf;
