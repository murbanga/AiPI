...
public:
	...
	int		InsertPage(const TCHAR* caption, CDialog* pwndTemplate, BOOL bAutoDestroyTpl=TRUE, int idx=-1);	//Return page zero-based index
	int		InsertPage(const TCHAR* caption, UINT nIDTemplate, int idx=-1);	//Return page zero-based index
	int		InsertPage(const TCHAR* caption, UINT nIDTemplate, CRuntimeClass* rtc, int idx=-1);	//Return page zero-based index
...
protected:
	...
	int		_InsertPage(const TCHAR* caption, CDialog* dlg, int idx, BOOL bAutoDestroyTpl);
