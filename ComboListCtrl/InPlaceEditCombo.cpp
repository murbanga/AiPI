...
CInPlaceEditCombo* CInPlaceEditCombo::m_pInPlaceEdit = NULL;  
...
BEGIN_MESSAGE_MAP(CInPlaceEditCombo, CEdit)
	//{{AFX_MSG_MAP(CInPlaceEditCombo)
	ON_WM_KILLFOCUS()
	ON_WM_CHAR()
	ON_WM_CREATE()

#if _MSC_VER >= 1310  // VC7.1
	ON_MESSAGE(WM_PASTE, (LRESULT(AFX_MSG_CALL CWnd::*)(WPARAM, LPARAM))OnPaste)
#else
...
/////////////////////////////////////////////////////////////////////////////
// CInPlaceEditCombo message handlers

void CInPlaceEditCombo::OnPaste(WPARAM /*wParam*/, LPARAM /*lParam*/)
{
...
void CInPlaceEditCombo::OnKillFocus(CWnd* pNewWnd) 
{
...
void CInPlaceEditCombo::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
BOOL CInPlaceEditCombo::PreTranslateMessage(MSG* pMsg) 
{
...
int CInPlaceEditCombo::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
CInPlaceEditCombo* CInPlaceEditCombo::GetInstance()
{
	if(m_pInPlaceEdit == NULL)
	{
		m_pInPlaceEdit = new CInPlaceEditCombo;
	}
	return m_pInPlaceEdit;
}

void CInPlaceEditCombo::DeleteInstance()
{
	delete m_pInPlaceEdit;
	m_pInPlaceEdit = NULL;
}

BOOL CInPlaceEditCombo::ShowEditCtrl(DWORD dwStyle, const RECT &rCellRect, CWnd* pParentWnd, 
