// Aipi_ExpParserGUIGlobal.cpp: implementation of the CAipi_ExpParserGUIGlobal class.
//
//////////////////////////////////////////////////////////////////////
...
CAipi_ExpParserGUIGlobal::CAipi_ExpParserGUIGlobal()
{
	//Data Base 
	...
	g_currentParserClass = EXP_PARSER_GUI_GLOBAL;
}
...
//// SQL OleDB DataBase /////
///////////////////////////////////////////////////////////////////////////////////
int CAipi_ExpParserGUIGlobal::SqlSelectDB(tstring db)
{
...
void CAipi_ExpParserGUIGlobal::SqlShowDBDlg()
{
...
void CAipi_ExpParserGUIGlobal::SqlOpenConnectionDlg()
{
...
void CAipi_ExpParserGUIGlobal::SqlOpenOleDB()
{
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
CString CAipi_ExpParserGUIGlobal::LiteralVarSearch(long iform, CString strToken )
{
...
double CAipi_ExpParserGUIGlobal::NumericVarSearch(long iform, CString strToken)
{
...
int CAipi_ExpParserGUIGlobal::matchToken(int tk )
{
	/*
	CString str;
...
void CAipi_ExpParserGUIGlobal::emit_declaration(int tk)
{
	
	if ( tk == IDENTIFIER )
	{
		//AfxMessageBox(_T("EMIT GLOBAL DECLARATION IDENTIFIER"));
	...
	{
		//AfxMessageBox(_T("EMIT GLOBAL DECLARATION EQUAL"));
		/*
		CString str;
...
void CAipi_ExpParserGUIGlobal::emit_expression(int tk)
{
	CAipi_Lexer lex;
...
void CAipi_ExpParserGUIGlobal::initExpParser()
{
	//AfxMessageBox(_T("Entro Parser GUI Global"));
	m_endPos = g_currentDocEndPos;
	translation_unit();
	//AfxMessageBox(_T("Salio Parser GUI Global"));
...
void CAipi_ExpParserGUIGlobal::translation_unit()
{
	...
	if( m_lookahead != NUL )
	{
		  ...
		  )	
		{
			...
			//AfxMessageBox(_T("Entro Declaration GUI Global"));
			declaration();
			translation_unit();
		}
		...
		{
			//AfxMessageBox(_T("Entro a Expression GUI Global"));
			expression();
			translation_unit();
		}
		else if( m_lookahead == AIPI_OUTPUT )
		{
			//AfxMessageBox(_T("Entro a OUTPUT GUI Global"));
			cmd_output();
			translation_unit();
		}
		...
		{
			//AfxMessageBox(_T("GETIN  DisplayCtrl"));
			...
			//AfxMessageBox(_T("EXIT DisplayCtrl"));
			translation_unit();
		...
		{
			//AfxMessageBox(_T("Sale de GUI Global"));
			CAipi_ParserGUI gui;
			gui.m_lookahead = m_lookahead;
			gui.translation_unit();
		}
...
void CAipi_ExpParserGUIGlobal::declaration_specifiers()
{
...
void CAipi_ExpParserGUIGlobal::declaration()
{
	/*
	CString str;
...
void CAipi_ExpParserGUIGlobal::declarator_list_init()
{
	declarator_init();
...
void CAipi_ExpParserGUIGlobal::declarator_init()
{
	declarator_direct();
...
void CAipi_ExpParserGUIGlobal::initializer()
{
...
void CAipi_ExpParserGUIGlobal::initializer_list()
{
	initializer();
...
void CAipi_ExpParserGUIGlobal::declarator_direct()
{
...
void CAipi_ExpParserGUIGlobal::parameter_declaration()
{
...
void CAipi_ExpParserGUIGlobal::parameter_list()
{
...
///// Expression Parser /////
/////////////////////////////////////////////////////////////////////////////////////////////
void CAipi_ExpParserGUIGlobal::expression_argument_list()
{
	expression_assignment();
...
void CAipi_ExpParserGUIGlobal::expression()
{
...
void CAipi_ExpParserGUIGlobal::expression_assignment()
{
	if( m_lookahead == EQUAL)
	{
		matchToken(EQUAL);
...
void CAipi_ExpParserGUIGlobal::expression_logical_or()
{
...
void CAipi_ExpParserGUIGlobal::expression_logical_and()
{
	expression_equality();
...
void CAipi_ExpParserGUIGlobal::expression_equality()
{
...
void CAipi_ExpParserGUIGlobal::expression_relational()
{
...
void CAipi_ExpParserGUIGlobal::expression_aritmetic()
{
	expression_term();
...
void CAipi_ExpParserGUIGlobal::expression_term()
{
	expression_factor();
...
void CAipi_ExpParserGUIGlobal::expression_unary_plus()
{
...
void CAipi_ExpParserGUIGlobal::expression_unary_minus()
{
...
void CAipi_ExpParserGUIGlobal::expression_unary_increment()
{
...
void CAipi_ExpParserGUIGlobal::expression_unary_decrement()
{
...
void CAipi_ExpParserGUIGlobal::expression_factor()
{
	switch(m_lookahead)
	{
	case IDENTIFIER:
...
void CAipi_ExpParserGUIGlobal::expression_atom_identifier()
{
...
void CAipi_ExpParserGUIGlobal::expression_atom_constant()
{
...
void CAipi_ExpParserGUIGlobal::expression_atom_literal()
{
...
void CAipi_ExpParserGUIGlobal::type_name()
{
...
void CAipi_ExpParserGUIGlobal::operator_unary()
{
	switch(m_lookahead)
	{
	case PLUS_SIGN:
...
void CAipi_ExpParserGUIGlobal::operator_assigment()
{
	switch(m_lookahead)
	{
	case EQUAL:
...
void CAipi_ExpParserGUIGlobal::cmd_db_open()
{
...
void CAipi_ExpParserGUIGlobal::cmd_db_open_parameter()
{
...
void CAipi_ExpParserGUIGlobal::cmd_db_open_parameter_list()
{
...
void CAipi_ExpParserGUIGlobal::cmd_db_close()
{
	matchToken(AIPI_DB_CLOSE);

}

void CAipi_ExpParserGUIGlobal::cmd_output()
{
	CAipi_Tokenizer tkz;
	...
	if ( m_lookahead == LEFT_OP )
	{
		while( m_lookahead != SEMICOLON && m_lookahead != NUL)
		{
			...
			if( m_lookahead == LITERAL )
			{
				matchToken(LITERAL);
				//getTokenizer();
				long literal = tkz.v_lastIntFormToken();
				//Search in global variables
				CAipi_STableGlobalLiteral tlit;
				tstring slit = tlit.findIdValue(literal);
				if( slit != _T("NOT_FOUND"))
				{
					//AfxMessageBox(_T("Output Literal"));
					matchToken(LEFT_OP);
					//getTokenizer();
				}
				else
				{
					//AfxMessageBox(_T("LIT ERROR"));
				}
			...
			else if( m_lookahead == IDENTIFIER )
			{
				...
				long identifier = tkz.v_lastIntFormToken();
				//Search in global variables
				CAipi_STableGlobalLiteral tlit;
				tstring slit = tlit.findIdValue(identifier);
				if( slit != _T("NOT_FOUND"))
				{
					//AfxMessageBox(_T("Output ID Literal"));
					matchToken(IDENTIFIER);
					//getTokenizer();
				...
				{
					CAipi_STableGlobalNumeric tnum;
					double dnum = tnum.findIdValue(identifier);
					if( dnum != NOT_FOUND )
					{
						//AfxMessageBox(_T("Output ID Numeric"));
						matchToken(IDENTIFIER);
						//getTokenizer();
...
int CAipi_ExpParserGUIGlobal::cmd_input()
{
	CAipi_Tokenizer tkz;
...
void CAipi_ExpParserGUIGlobal::cmd_input_continue()
{
	...
	*/			
	...
	/*
	CString str;
	str.Format(_T("CMD INPUT CONTINUE Look Ahead...%d  " ), m_lookahead);
	AfxMessageBox(str);
	*/
	...
	//AfxMessageBox(_T("ENTRO TRASLATON UNIT"));
	translation_unit();
...
void CAipi_ExpParserGUIGlobal::ctrl_jukebox()
{
...
void CAipi_ExpParserGUIGlobal::ctrl_mediaplayer()
{
...
void CAipi_ExpParserGUIGlobal::ctrl_imagefilter()
{
...
int CAipi_ExpParserGUIGlobal::ctrl_listoption()
{
...
void CAipi_ExpParserGUIGlobal::ctrl_listoption_continue()
{
	/*
	AfxMessageBox(_T("Input Val"));
	AfxMessageBox(g_currentCmdInput);
...
void CAipi_ExpParserGUIGlobal::ctrl_oledb()
{
