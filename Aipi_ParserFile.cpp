// Aipi_ParserFile.cpp: implementation of the CAipi_ParserFileFile class.
//
//////////////////////////////////////////////////////////////////////
...
CAipi_ParserFile::CAipi_ParserFile()
{
	...
	//g_currentParserClass = PARSER_FILE;
}
...
CString CAipi_ParserFile::LiteralVarSearch(long iform)
{
...
double CAipi_ParserFile::NumericVarSearch(long iform)
{
...
bool CAipi_ParserFile::ScriptLoadCode(long nStartSel, long nEndSel, int line, CString lang, CString code, CString name) 
{
...
void CAipi_ParserFile::ScriptDisplayError(long nStartSel, int line, CString name)
{
...
int CAipi_ParserFile::matchToken(int tk )
{
	...
	*/	
	...
	//AfxMessageBox(_T("ParserFile LEXER TOKEN......"));
	//AfxMessageBox(lex.m_sToken);
	
	/*
	CString str;
	str.Format(_T("matchToken Line...%d  " ), g_currentLine);
	AfxMessageBox(str);
	*/
...
void CAipi_ParserFile::initParser(CString sfileName)
{
	
	//AfxMessageBox(_T("****Entro PARSER FILE****"));
	...
	g_currentFile = sfileName;
	//AfxMessageBox(g_currentFile);

	
	const  TCHAR* cFileName = (LPCTSTR)sfileName; 
	...
	m_fendPos = ftell(g_fp);
	g_currentDocEndPos = m_fendPos;
	...
	AfxMessageBox(_T("Entro Parser File"));
	translation_unit();
	AfxMessageBox(_T("Salio Parser File"));
	

	if( g_bStopFlag != true )
	{
		AfxMessageBox(_T("CLOSE Fichero"));
		fclose(g_fp);
...
void CAipi_ParserFile::endParser()
{
	CMainFrame* pMainFrame = (CMainFrame*)::AfxGetMainWnd();
	...
	//AfxMessageBox(_T("****Salio PARSER FILE****"));
		...
		/*
		CAipi_Error err;
		err.displayRunTimeFileError(EMPTY_MSG, -1, g_currentFile, _T(" *************************************************************************************************************"));
		err.displayRunTimeFileError(ERROR_COUNT, INFO_ERROR, g_currentFile, _T(" Lexical errors:...") + strLex + _T("   Sintax errors:...") + strSintax + _T("   Semantic errors:...") + strSemant + _T("                    *Total errors:...") + str_nError );
		err.displayRunTimeFileError(WARNING_COUNT, INFO_ERROR, g_currentFile, _T(" Warnings:...") + strWarning + _T("   Warning questions:...") + strQuestion + _T("                    *Total warnings:...") + str_nWarning );
		err.displayRunTimeFileError(FINISH, INFO_ERROR, g_currentFile, _T("   **** Debug Summary:-    ") + str_nError + _T(" error(s),   ") + str_nWarning + _T(" warning(s). ****" ));
		*/
...
void CAipi_ParserFile::emit_rule(int tk)
{
	if( tk == AIPI_RULE )
	{
		CAipi_PM pm;
...
void CAipi_ParserFile::translation_unit()
{
	g_currentParserClass = PARSER_FILE;
	
	//AfxMessageBox(_T("Entro TranslationUnit ParserFile"));
	...
	*/
	...
	if( m_lookahead != _TEOF )
	{
			  ...
			  )	
		{
			...
			CAipi_ExpParserFileGlobal glob;
			glob.m_lookahead =  m_lookahead;
			glob.initExpParserFileGlobal();
		...
		else
		{
			...
			//AfxMessageBox(_T("Sale de ParserFile"));
...
void CAipi_ParserFile::script_translation_unit()
{
	/*
	AfxMessageBox(_T("Translation Unit"));
	CString str;
...
void CAipi_ParserFile::directive_list()
{
...
void CAipi_ParserFile::directive()
{
	if( m_lookahead == NUMBER_SIGN )
	{
		...
		{
			CAipi_Error err;
			err.displayFileError(FILE_READ, STOP_ERROR,_T("ERROR: The file  (") + strFileName + _T(") could not be linked. Check if the file extension in correct."));
			return;
		}
		else
		{
...
void CAipi_ParserFile::cr_strategy()
{
...
int CAipi_ParserFile::attribute_type()
{
	//CString  str;
...
void CAipi_ParserFile::class_attr_declaration(long class_iform, tstring class_name )
{
...
void CAipi_ParserFile::class_attr_declaration_list(long class_iform, tstring class_name)
{
...
void CAipi_ParserFile::class_element()
{
...
void CAipi_ParserFile::class_element_list()
{
	class_element();
	if( m_lookahead == AIPI_CLASS )
	{
...
void CAipi_ParserFile::rule_element()
{
	CAipi_Tokenizer tkz;
...
void CAipi_ParserFile::rule_element_list()
{
	rule_element();
...
void CAipi_ParserFile::rule_parameter()
{
...
void CAipi_ParserFile::rule_parameter_list()
{
...
void CAipi_ParserFile::lhs_start()
{
...
void CAipi_ParserFile::lhs_connector()
{
...
void CAipi_ParserFile::lhs_element()
{
...
void CAipi_ParserFile::rhs_action_fact()
{
	switch(m_lookahead)
	{
		case AIPI_ASSERT:
...
void CAipi_ParserFile::rhs_action_command()
{
...
void CAipi_ParserFile::rhs_action_ctrl()
{
...
void CAipi_ParserFile::rhs_action_script()
{
...
void CAipi_ParserFile::wm_element()
{
...
void CAipi_ParserFile::wm_element_list()
{
	wm_element();
...
void CAipi_ParserFile::wm_attribute_value_list()
{
	wm_attribute_value();
	emit_rule(AIPI_WM);
...
void CAipi_ParserFile::wm_attribute_value()
{
	double dId = UNDEFINE;
	CAipi_Tokenizer tkz;
...
void CAipi_ParserFile::wm_multi_attribute_value()
{
	CAipi_Tokenizer tkz;
	CAipi_Symbol sym;
...
void CAipi_ParserFile::wm_parameter()
{
	if( m_lookahead == AIPI_CF)
	{
		matchToken(AIPI_CF);
...
void CAipi_ParserFile::wm_parameter_list()
{
	wm_parameter();
...
void CAipi_ParserFile::lhs_element_list()
{
...
void CAipi_ParserFile::lhs_attribute_value_list()
{
...
void CAipi_ParserFile::lhs_fact_address()
{
	if( m_lookahead == OPEN_PARENTHESIS )
	{
		matchToken(OPEN_PARENTHESIS);
...
void CAipi_ParserFile::rhs_start()
{
...
void CAipi_ParserFile::rhs_connector()
{
	if( m_lookahead == AIPI_AND )
	{
		matchToken(AIPI_AND);
...
void CAipi_ParserFile::rhs_element_list()
{
	rhs_element();
...
void CAipi_ParserFile::rhs_element()
{
...
void CAipi_ParserFile::lhs_attribute_value()
{
	CAipi_Tokenizer tkz;
	CAipi_Symbol sym;
	double dId = UNDEFINE;
...
void CAipi_ParserFile::lhs_multi_attribute_value()
{
	CAipi_Tokenizer tkz;
	CAipi_Symbol sym;
			...
			switch(m_lookahead)
			{
				...
				case GE:
					...
					if( m_lookahead == AIPI_VAR )
					{
						m_categVal = AIPI_VL;
						m_currentVal =  tkz.v_lastToken();
						m_currentVal = tkz.v_lastIntFormToken();
...
void CAipi_ParserFile::rhs_attribute_value_list()
{
	rhs_attribute_value();
	emit_rule(AIPI_RHS);
...
void CAipi_ParserFile::rhs_parameter()
{
	if( m_lookahead == AIPI_CF)
	{
		matchToken(AIPI_CF);
...
void CAipi_ParserFile::rhs_parameter_list()
{
	rhs_parameter();
...
void CAipi_ParserFile::rhs_attribute_value()
{
	CAipi_Tokenizer tkz;
	m_currentAttr =  tkz.v_lastToken();
	m_currentAttrIForm = tkz.v_lastIntFormToken();
	...
	switch(m_lookahead)
	{
		...
		case LE:
			...
			//AfxMessageBox(_T("LESS OR EQUAL THAN VALUE DIGIT"));
			//AfxMessageBox(m_currentVal.data());
		...
		case GE:
			...
			//AfxMessageBox(_T("GREATER OR EQUAL THAN VALUE DIGIT"));
			//AfxMessageBox(m_currentVal.data());
...
void CAipi_ParserFile::rhs_multi_attribute_value()
{
	CAipi_Tokenizer tkz;
	CAipi_Symbol sym;
...
/// Declaration Parser ////
//////////////////////////////////////////////////////////////////////////////////////////////////
void CAipi_ParserFile::declaration_specifiers()
{
...
void CAipi_ParserFile::declaration()
{
...
void CAipi_ParserFile::declarator_list_init()
{
	declarator_init();
...
void CAipi_ParserFile::declarator_init()
{
	declarator_direct();
...
void CAipi_ParserFile::initializer()
{
...
void CAipi_ParserFile::initializer_list()
{
...
void CAipi_ParserFile::declarator_direct()
{
...
void CAipi_ParserFile::parameter_declaration()
{
...
void CAipi_ParserFile::parameter_list()
{
...
//// Expression parser ////
//////////////////////////////////////////////////////////////////////////
void CAipi_ParserFile::expression_statement()
{
...
void CAipi_ParserFile::expression()
{
...
void CAipi_ParserFile::expression_assignment()
{
	if( m_lookahead == EQUAL)
	{
		matchToken(EQUAL);
...
void CAipi_ParserFile::expression_logical_or()
{
...
void CAipi_ParserFile::expression_logical_and()
{
	expression_equality();
...
void CAipi_ParserFile::expression_equality()
{
...
void CAipi_ParserFile::expression_relational()
{
...
void CAipi_ParserFile::expression_aritmetic()
{
	expression_term();
...
void CAipi_ParserFile::expression_term()
{
	expression_factor();
	while(true)
	{
...
void CAipi_ParserFile::expression_unary_plus()
{
...
void CAipi_ParserFile::expression_unary_minus()
{
...
void CAipi_ParserFile::expression_unary_increment()
{
...
void CAipi_ParserFile::expression_unary_decrement()
{
	matchToken(DEC_OP);
	//It just apply to identifiers
	if( m_lookahead = IDENTIFIER )
...
void CAipi_ParserFile::expression_factor()
{
	switch(m_lookahead)
	{
	case IDENTIFIER:
...
void CAipi_ParserFile::expression_atom_identifier()
{
	//CAipi_ScriptCode scpt;
	//scpt.findScriptMembers()
	matchToken(IDENTIFIER);
...
void CAipi_ParserFile::expression_argument_list()
{
	expression_assignment();
...
void CAipi_ParserFile::expression_atom_constant()
{
	matchToken(DIGIT);

}

void CAipi_ParserFile::expression_atom_literal()
{
	matchToken(LITERAL);
}
...
//// AIPI Commands ////
////////////////////////////////////////////////////////////////////////////
void CAipi_ParserFile::cmd_db_open()
{
...
void CAipi_ParserFile::cmd_db_open_parameter()
{
...
void CAipi_ParserFile::cmd_db_open_parameter_list()
{
...
void CAipi_ParserFile::cmd_db_close()
{
...
void CAipi_ParserFile::cmd_printout()
{
...
void CAipi_ParserFile::cmd_output()
{
...
void CAipi_ParserFile::cmd_input()
{
...
void CAipi_ParserFile::ctrl_jukebox()
{
...
void CAipi_ParserFile::ctrl_mediaplayer()
{
...
void CAipi_ParserFile::ctrl_imagefilter()
{
	m_currentCmd = AIPI_CTRL_IMAGEFILTER;
	emit_rule(AIPI_RHSCMD);
...
void CAipi_ParserFile::ctrl_listoption()
{
...
void CAipi_ParserFile::ctrl_oledb()
{
	m_currentCmd = AIPI_CTRL_OLEDB;
	emit_rule(AIPI_RHSCMD);
...
//// Script Parser ////
//////////////////////////////////////////////////////////////////////////
void CAipi_ParserFile::script_definition()
{
	...
	while(m_lookahead != LT && m_lookahead != _TEOF )
	{
		TCHAR symbol =  _gettc(g_fp);
		m_lookahead = lex.addTokenizerFile(symbol);
...
void CAipi_ParserFile::script_js_function_definition()
{
	...
	long index1 = tkz.v_sizeTokenizer()-1;
	long index2 = 0;
	fpos_t pos1 = tkz.v_lastPosition();
	fpos_t pos2 = 0;
	...
	{
		++openBrace;
		while (openBrace != closeBrace && m_lookahead != _TEOF)
		{
			...
			str.Format(_T("Look Ahead BRACE...%d  " ), m_lookahead);
			AfxMessageBox(str);
			*/
...
void CAipi_ParserFile::script_vbs_function_definition()
{
	...
	*/
	...
	//str.Format(_T("g_currentPos...%d  " ), g_currentPos);
	//AfxMessageBox(str);
	while(m_lookahead != VBS_END && m_lookahead != _TEOF )
	{
		symbol =  _gettc(g_fp);
		m_lookahead = lex.addTokenizerFile(symbol);
	...
	matchToken(VBS_END);
	long index2 = tkz.v_sizeTokenizer()-1;
	fpos_t pos2 = tkz.v_lastPosition() + 8;
	matchToken(VBS_FUNCTION);
...
void CAipi_ParserFile::script_sql()
{
	CString str;
	CAipi_Tokenizer tkz;
