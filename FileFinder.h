...
public:
	...
	class CFindOpts
	{
		public:
			...
			void FindNormalFiles()
			{
				...
				dwFileAttributes |= FILE_ATTRIBUTE_NORMAL | FILE_ATTRIBUTE_READONLY | 
	...
	BOOL	FindTextInFileExt(LPCTSTR szFile, LPCTSTR szText);

	BOOL	FindTextInFileAipi(LPCTSTR szFile, LPCTSTR szText);
	...
	CPathFinder	GetFilePath(int nIndex);
