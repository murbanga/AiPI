...
public:
	CPathFinder();
	CPathFinder(LPCTSTR szPath, BOOL bIsFolderPath = FALSE, BOOL bHasArguments = FALSE);
	CPathFinder(DWORD dwSpecial);
	virtual ~CPathFinder();
	...
	const CPathFinder& operator = (LPCTSTR szPath);

	// Makes a copy of the object
	const CPathFinder& operator = (CPathFinder &ref);
...
#endif // !defined(__PATHFINDER_H__)
