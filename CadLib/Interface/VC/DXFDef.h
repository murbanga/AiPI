...
{
	{_T("ClosedFilled"), 1, _T("SOLID"), 0, 0, -1, -0.1667, -1, 0.1667, -1, 0.1667},
	{_T("ClosedFilled"), 2, _T("SOLID"), 0, 0, -1, -0.1667, -1, 0.1667, -1, 0.1667},
	{_T("Oblique"), 1, _T("LINE"), -0.5, -0.5, 0.5, 0.5, 0, 0, 0, 0},
	{_T("Oblique"), 2, _T("LINE"), -0.5, -0.5, 0.5, 0.5, 0, 0, 0, 0},
};
