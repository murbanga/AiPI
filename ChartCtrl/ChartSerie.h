...
#ifdef UNICODE
	void		SetName(std::wstring NewName) { m_strSerieName = NewName; }
	std::wstring GetName() const              { return m_strSerieName; }
#else
...
#ifdef _UNICODE
	std::wstring m_strSerieName;		// Name displayed in the legend
#else	
