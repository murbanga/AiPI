...
#ifdef _UNICODE
	void SetText(std::wstring NewText) { m_strLabelText = NewText;}
	std::wstring GetText() const       { return m_strLabelText;}
	void SetFont(int nPointSize,std::wstring strFaceName)
	{
